...
//sys hcsStartDNSServer(id string, ioPipe *syscall.Handle) (hr error) = vmcompute.HcsStartDNSServer?
//sys hcsStopDNSServer(id string) (hr error) = vmcompute.HcsStopDNSServer?
